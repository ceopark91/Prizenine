  ...
  useEffect(() => {
    ...
    const register = async () => {
      ...
      await context.registerTool({
        ...
        description: '6자리 상품번호의 Topview 영상 제작 작업을 큐에 넣고 화면 상태를 갱신합니다.',
